            ...
            <div class="col-lg-12">
                <div class="breadcrumb_iner text-center">
                    <div class="breadcrumb_iner_item">
                        ...
                        <p>Home<span>/</span>{{$courses->category->name}}<span>/</span>{{$courses->name}}</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-8 course_details_left">
                <div class="main_image">
                    <img class="img-fluid" src="{{asset("front/courses/$courses->image")}}" alt="">
                </div>
                ...
                <div class="container mt-3">
                    <form class="form-contact contact_form" action="{{route("front.message.enroll")}}" method="post" id="contactForm" novalidate="novalidate">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="form-group">
                              <input class="form-control" name="spec" id="speclist" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Speclist'" placeholder = 'Enter Speclist'>
                            </div>
                          </div>
                        </div>
