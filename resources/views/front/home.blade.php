                ...
                <div class="col-lg-6 col-xl-6">
                    <div class="banner_text">
                        <div class="banner_text_iner">
                            <h5>{{json_decode($data["banner"]->content)->title}}</h5>
                            <h1>{{json_decode($data["banner"]->content)->subtitle}}</h1>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">{{$data["Courses"]}}</span>
                        <h4>Courses</h4>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">{{ $data["Students"]}}</span>
                        <h4>  Students</h4>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_member_counter">
                        <span class="counter">{{$data["Trainers"]}}</span>
                        <h4>Trainers</h4>
                    </div>
                </div>
